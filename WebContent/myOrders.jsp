...
<%@ page import="controller.ListOrdersById" %>
...
<body>
   		...
   		<div class="container">
        	<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav">
                    <li>
                    	<a href="customer.jsp">Main Page</a>
                    </li>
                    <li>
	...
	<div class="row">        
        ...
        <div class="table-responsive">                
			...
			<tbody>   
   			<%
   			ListOrdersById manager = new ListOrdersById();
   			manager.doGet(request, response);
    		List<Orders> ordersListById = (List<Orders>)session.getAttribute("ordersListById");
    		if(ordersListById == null){
    ...
    <form calss="btn" method="get" action="DeleteOrder">
